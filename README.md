...
- Download [MarkLogic 8.0-2 for CentOS](http://developer.marklogic.com/products) (login required)
- Download [MLCP 1.3-2 binaries](http://developer.marklogic.com/download/binaries/mlcp/mlcp-Hadoop2-1.3-2-bin.zip)
