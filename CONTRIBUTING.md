# Contributing to mlvagrant

mlvagrant welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use mlvagrant, check the [README][readme]. Alternatively, check our [GitHub Issue Tracker][issue tracker] to see if it has been answered there, and post your question there if not.
...
* **mlvagrant Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/mlvagrant/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/mlvagrant.git
$ cd mlvagrant
$ git remote add upstream git://github.com/grtjn/mlvagrant.git
```
...
Go to https://github.com/username/mlvagrant and select your feature branch. Click
